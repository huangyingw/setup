...
if [ ! -f "$SCRIPTPATH/installer/cuda_9.0.176_384.81_linux.run" ]
then
...
sh $SCRIPTPATH/installer/cuda_9.0.176_384.81_linux.run --silent --toolkit --samples --samplespath=/media/volgrp --tmpdir=/media/volgrp/temp/
